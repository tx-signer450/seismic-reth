...
//}
//
//impl SeismicPayloadTransactions<SeismicPooledTransaction> for CustomTxPriority {
//    fn best_transactions<Pool>(
//        &self,
//        pool: Pool,
//        attr: reth_transaction_pool::BestTransactionsAttributes,
//    ) -> impl PayloadTransactions<Transaction = SeismicPooledTransaction>
//    where
//        Pool: reth_transaction_pool::TransactionPool<Transaction = SeismicPooledTransaction>,
//    {
//        // Block composition:
...
//        let end_of_block_tx = SeismicPooledTransaction::from_pooled(Recovered::new_unchecked(
//            SeismicPooledTransaction::Eip1559(
