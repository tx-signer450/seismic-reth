...
impl AccountStorageCache {
    ...
    /// Get a storage value
    pub(crate) fn get_storage(&self, key: &StorageKey) -> Option<Option<FlaggedStorage>> {
        self.slots.get(key)
    }
...
mod tests {
    ...
    fn measure_storage_cache_overhead() {
        ...
        let value = FlaggedStorage::new_from_value(rng.gen::<u128>());
